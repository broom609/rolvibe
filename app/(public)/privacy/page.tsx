  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      ...
      <div className="prose prose-invert max-w-none space-y-6 text-[var(--text-secondary)] text-sm leading-relaxed">
        ...
        <h2 className="text-lg font-semibold text-[var(--text-primary)]">How we use it</h2>
        ...
        <h2 className="text-lg font-semibold text-[var(--text-primary)]">Third parties</h2>
        ...
        <p>You can request deletion of your account and data by emailing <a href="mailto:hello@rolvibe.com" className="text-[var(--text-primary)] underline">hello@rolvibe.com</a>. We will process deletion requests within 30 days.</p>
      </div>
    </div>
  )
}
