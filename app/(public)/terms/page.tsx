export default function TermsPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <h1 className="text-2xl font-bold text-[#F4F4F5] mb-8">Terms of Service</h1>
      <div className="prose prose-invert max-w-none space-y-6 text-[#A1A1AA] text-sm leading-relaxed">
        ...
        <h2 className="text-lg font-semibold text-[#F4F4F5]">1. Using Rolvibe</h2>
        ...
        <h2 className="text-lg font-semibold text-[#F4F4F5]">2. Creator Responsibilities</h2>
        ...
        <h2 className="text-lg font-semibold text-[#F4F4F5]">3. Payments</h2>
        ...
        <h2 className="text-lg font-semibold text-[#F4F4F5]">4. Content Policy</h2>
        ...
        <h2 className="text-lg font-semibold text-[#F4F4F5]">5. Limitation of Liability</h2>
        ...
        <h2 className="text-lg font-semibold text-[#F4F4F5]">6. Changes</h2>
        <p>We may update these terms from time to time. Continued use of Rolvibe after changes constitutes acceptance.</p>
        <p>Questions? Email us at <a href="mailto:hello@rolvibe.com" className="text-[#F4F4F5] underline">hello@rolvibe.com</a></p>
      </div>
    </div>
  )
}
