export default function GuidelinesPage() {
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <h1 className="text-2xl font-bold text-[var(--text-primary)] mb-8">Creator Guidelines</h1>
      <div className="space-y-6 text-[var(--text-secondary)] text-sm leading-relaxed">
        ...
        <h2 className="text-lg font-semibold text-[var(--text-primary)]">Review process</h2>
        ...
        <p>Questions? <a href="mailto:hello@rolvibe.com" className="text-[var(--text-primary)] underline">hello@rolvibe.com</a></p>
      </div>
    </div>
  )
}
